...
/** Handles typed events that occur while parsing a LookML object.
 *
 * <p>Similar to {@link ObjectHandler}, except that the type of
 * every object and property is known.
 *
 * @see ListHandler */
