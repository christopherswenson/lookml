...
public interface LookmlSchema {
   ...
   *
   * <p>For example, an 'employee' object type might have the following
   * four properties:
   * <ul>
   *   <li>(name = "empno", type = NUMBER, typeName = "")
   *   <li>(name = "first_name", type = STRING, typeName = "")
   *   <li>(name = "last_name", type = STRING, typeName = "")
   *   <li>(name = "job", type = ENUM, typeName = "job_type")
   * </ul>
   *
   * <p>The last property references an {@link EnumType} named 'job_type'
